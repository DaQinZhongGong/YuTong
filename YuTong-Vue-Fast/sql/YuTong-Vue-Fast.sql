...
values (100, 0, '0', '雨桐科技', 0, '雨桐', '15888888888', 'yt@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (101, 100, '0,100', '深圳总公司', 1, '雨桐', '15888888888', 'yt@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (102, 100, '0,100', '长沙分公司', 2, '雨桐', '15888888888', 'yt@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (103, 101, '0,100,101', '研发部门', 1, '雨桐', '15888888888', 'yt@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (104, 101, '0,100,101', '市场部门', 2, '雨桐', '15888888888', 'yt@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (105, 101, '0,100,101', '测试部门', 3, '雨桐', '15888888888', 'yt@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (106, 101, '0,100,101', '财务部门', 4, '雨桐', '15888888888', 'yt@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (107, 101, '0,100,101', '运维部门', 5, '雨桐', '15888888888', 'yt@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (108, 102, '0,100,102', '市场部门', 1, '雨桐', '15888888888', 'yt@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (109, 102, '0,100,102', '财务部门', 2, '雨桐', '15888888888', 'yt@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
...
values ('3', '系统工具', '0', '3', 'tool', null, '', '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', sysdate(), '', null,
        '系统工具目录');
insert into sys_menu
values ('4', '雨桐官网', '0', '4', 'http://yutongvuefast.vip', null, '', '', 0, 0, 'M', '0', '0', '', 'guide', 'admin',
        sysdate(), '', null, '雨桐官网地址');
-- 二级菜单
insert into sys_menu
...
values (1, '系统默认（无参）', 'DEFAULT', 'ryTask.ryNoParams', '0/10 * * * * ?', '3', '1', '1', 'admin', sysdate(), '',
        null, '');
insert into sys_job
values (2, '系统默认（有参）', 'DEFAULT', 'ryTask.ryParams(\'yt\')', '0/15 * * * * ?', '3', '1', '1', 'admin', sysdate(),
        '', null, '');
insert into sys_job
values (3, '系统默认（多参）', 'DEFAULT', 'ryTask.ryMultipleParams(\'yt\', true, 2000L, 316.50D, 100)', '0/20 * * * * ?',
...
values ('1', '温馨提醒：2018-07-01 雨桐新版本发布啦', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice
values ('2', '维护通知：2018-07-01 雨桐系统凌晨维护', '1', '维护内容', '0', 'admin', sysdate(), '', null, '管理员');
