package com.yutongvuefast.common.utils.file;

import com.yutongvuefast.common.constant.Constants;
import com.yutongvuefast.common.exception.file.FileNameLengthLimitExceededException;
import com.yutongvuefast.common.exception.file.FileSizeLimitExceededException;
import com.yutongvuefast.common.exception.file.InvalidExtensionException;
import com.yutongvuefast.common.utils.DateUtils;
import com.yutongvuefast.common.utils.StringUtils;
import com.yutongvuefast.common.utils.uuid.IdUtils;
import com.yutongvuefast.common.utils.uuid.Seq;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = YuTongVueFastConfig.getProfile();
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = YuTongVueFastConfig.getProfile().length() + 1;
